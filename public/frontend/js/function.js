(function ($) {
	...
	/* How Work Steps Active Start */
	var $how_work_steps_box = $('.how-work-steps-box');
	if ($how_work_steps_box.length) {
		var $how_work_step = $how_work_steps_box.find('.how-work-step');

		if ($how_work_step.length) {
			$how_work_step.on({
				mouseenter: function () {
					if (!$(this).hasClass('active')) {
						$how_work_step.removeClass('active'); 
						$(this).addClass('active'); 
					}
				},
				mouseleave: function () {
