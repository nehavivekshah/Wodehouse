        ...
        <aside class="member-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li>
                        <a href="/admin/facility-bookings">
                ...
                <div class="header-right">
                    ...
                    <div class="dropdown header-profile">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="/member/profile"><i
                                        class="fas fa-user-circle fa-fw me-2"></i> My Profile</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="/member/change_password"><i
                                        class="fas fa-key fa-fw me-2"></i> Change Password</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
